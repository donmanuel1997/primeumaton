        ...
        <div className=' h-screen bg-gray-900 flex flex-col space-y-8 items-center justify-center
         overflow-hidden'>
            ...
            <div className='flex flex-col justify-center items-center text-white top-0'>
                <div className='px-2 text-sm uppercase tracking-[3px]'>¬ FULL STACK DEVELOPER ¬</div>
                <div className='px-2 text-sm uppercase tracking-[3px]'>¬ CYBER SECURITY EXPERT ¬</div>
